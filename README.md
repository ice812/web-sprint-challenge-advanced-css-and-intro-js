...
Acessibility are features to help people with that can't view the normal page or people that use screen readers.

2. Talk about 3 different things you can do to ensure your website is accessible. 
Use semantic html as much as possible to describe the purpose of each element.
Use alt text to describe an image.
Use the title attribute to provide extra info about an element.

3. How would you explain the concept of a variable to someone new to programming?
A variable is a place to hold data that can be changed at anytime.

4. What is the purpose of using functions in code?
It's a way to store single tasks that can be used when needed instead of typing out the same code over and over.
